...
Cada unidad tiene cuatros fases. Cada fase tiene un peso relativo en la nota de la unidad. En cada fase hay actividades. Todas las actividades de la fase tienen el mismo valor.
...
Cada unidad tendrá en peso del 12.5% en la nota final.
